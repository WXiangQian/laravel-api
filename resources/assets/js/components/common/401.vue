        ...
        <el-row>
            <el-col :span="12">
                ...
                <ul class="list-unstyled">
                    ...
                    <li class="link-type"><a href='https://github.com/WXiangQian' target='_blank'>GitHub</a></li>
                    <li class="link-type"><a href='https://blog.csdn.net/qq175023117' target='_blank'>CSDN</a></li>
